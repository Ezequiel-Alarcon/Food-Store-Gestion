...
class Usuario(SQLModel, table=True):
    ...
    Campos:
        ...
        - rol: Rol del usuario (ADMIN, GESTOR, CLIENT)
    ...
    rol: str = Field(default=RolEnum.CLIENT.value, description="Rol del usuario")
    ...
    updated_at: datetime = Field(default_factory=datetime.utcnow, description="Fecha de última modificación")
