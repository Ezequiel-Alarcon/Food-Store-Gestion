...
- [ ] Un ADMIN puede crear productos con nombre, precio, stock, categorías e ingredientes
- [ ] Un GESTOR_STOCK puede crear productos pero no eliminar
- [ ] El stock se puede modificar independientemente del producto
- [ ] La eliminación es soft-delete (no físico)
- [ ] Los productos eliminados no aparecen en listados públicos