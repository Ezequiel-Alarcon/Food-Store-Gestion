...
- [x] El catálogo público es accesible sin autenticación
- [x] Los productos eliminados/inactivos no aparecen en el catálogo
- [x] Se puede filtrar por categoría
- [x] Se puede excluir productos con alérgenos
- [x] Se puede excluir productos por ingredientes específicos
- [x] El detalle público no revela stock exacto